...
class MyWorker(Worker):
    ...
    def compute(self, config, budget, **kwargs):
        ...
        validation_error, model = train_vaidate(self.x_train, self.y_train, self.x_valid, self.y_valid, epochs, lr, num_filters, batch_size, filter_size)
    ...
    def get_configspace():
        ...
        batch_size =  CSH.UniformIntegerHyperparameter('batch_size', lower=16, upper=128, default_value=50, log = True)
        ...
        cs.add_hyperparameters([lr, batch_size, num_filters, size_filters])
...
validation_accuracy, model = train_vaidate(x_train, y_train,x_valid,y_valid, epochs, lr, num_filters, batch_size, filter_size)
